"""
Alembic environment configuration for Adaptive Immune System - HITL API.
...
# from hitl.database import Base
# target_metadata = Base.metadata

# For now, we'll use None until we create the database models
