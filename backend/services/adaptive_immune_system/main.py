...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        configure_constitutional_logging(
            service_name="adaptive_immune_system",
        ...
        auto_update_sabbath_status("adaptive_immune_system")
        ...
        # Health
        health_checker = ConstitutionalHealthCheck(service_name="adaptive_immune_system")
