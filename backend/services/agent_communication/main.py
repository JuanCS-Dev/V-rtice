"""
agent_communication - FastAPI service
"""
import logging
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        auto_update_sabbath_status("agent_communication")
        ...
        # Health
        health_checker = ConstitutionalHealthCheck(service_name="agent_communication")
    ...
    logger.info("Starting agent_communication...")
    yield
    logger.info("Shutting down agent_communication...")


app = FastAPI(
    title="agent_communication",
    version="0.1.0",
    lifespan=lifespan,
)
...
async def health():
    ...
    return {"status": "healthy", "service": "agent_communication"}
