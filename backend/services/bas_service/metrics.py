"""Maximus BAS Service - Metrics Utilities.

This module provides utilities for collecting, tracking, and reporting
operational metrics within the Breach and Attack Simulation (BAS) service.
It enables Maximus AI to monitor the performance and effectiveness of its
simulated attacks and the defensive responses of the target systems.

Metrics collected can include:
- Number of simulations started and completed.
- Success rates of attack techniques.
- Detection and response rates of security controls.
- Latency of simulation execution.

This module is crucial for evaluating the security posture, identifying areas
for improvement, and demonstrating the value of the BAS service.
"""
...
class MetricsCollector:
    """Collects, tracks, and reports operational metrics for the BAS service.

    Enables Maximus AI to monitor the performance and effectiveness of its
    simulated attacks and the defensive responses of the target systems.
    """
    ...
    def record_metric(self, metric_name: str, value: Optional[float] = None):
        ...
        Args:
            ...
            value (Optional[float]): An optional numerical value associated with the metric.
        """
        self.metrics[metric_name]["count"] += 1
        if value is not None:
            self.metrics[metric_name]["total_value"] += value
    ...
    def get_metric(self, metric_name: str) -> Dict[str, Any]:
        ...
        Returns:
            Dict[str, Any]: A dictionary containing the metric's count, total value, average value (if applicable), and last update.
        """
