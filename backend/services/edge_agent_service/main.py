"""
edge_agent_service - FastAPI service
"""
import logging
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        auto_update_sabbath_status("edge_agent_service")
        ...
        # Health
        health_checker = ConstitutionalHealthCheck(service_name="edge_agent_service")
    ...
    logger.info("Starting edge_agent_service...")
    yield
    logger.info("Shutting down edge_agent_service...")


app = FastAPI(
    title="edge_agent_service",
    version="0.1.0",
    lifespan=lifespan,
)
...
async def health():
    ...
    return {"status": "healthy", "service": "edge_agent_service"}
