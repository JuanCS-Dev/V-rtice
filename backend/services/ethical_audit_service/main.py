...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        configure_constitutional_logging(
            service_name="ethical_audit_service",
        ...
        auto_update_sabbath_status("ethical_audit_service")
        ...
        # Health
        health_checker = ConstitutionalHealthCheck(service_name="ethical_audit_service")
