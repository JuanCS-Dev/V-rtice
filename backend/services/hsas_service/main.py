...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        auto_update_sabbath_status("hsas_service")
        ...
        # Health
        health_checker = ConstitutionalHealthCheck(service_name="hsas_service")
    ...
    logger.info("Starting hsas_service...")
    yield
    logger.info("Shutting down hsas_service...")
...
async def health():
    ...
    return {"status": "healthy", "service": "hsas_service"}
