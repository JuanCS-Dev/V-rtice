"""
immunis_bcell_service - FastAPI service
"""
import logging
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        configure_constitutional_logging(
            service_name="immunis_bcell_service",
        ...
        auto_update_sabbath_status("immunis_bcell_service")
        ...
        # Health
        health_checker = ConstitutionalHealthCheck(service_name="immunis_bcell_service")
    ...
    logger.info("Starting immunis_bcell_service...")
    yield
    logger.info("Shutting down immunis_bcell_service...")


app = FastAPI(
    title="immunis_bcell_service",
    version="0.1.0",
    lifespan=lifespan,
)
...
async def health():
    ...
    return {"status": "healthy", "service": "immunis_bcell_service"}
