...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        configure_constitutional_logging(
            service_name="immunis_cytotoxic_t_service",
        ...
        auto_update_sabbath_status("immunis_cytotoxic_t_service")
        ...
        # Health
        health_checker = ConstitutionalHealthCheck(service_name="immunis_cytotoxic_t_service")
