"""
immunis_dendritic_service - FastAPI service
"""
import logging
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        configure_constitutional_logging(
            service_name="immunis_dendritic_service",
        ...
        auto_update_sabbath_status("immunis_dendritic_service")
        ...
        # Health
        health_checker = ConstitutionalHealthCheck(service_name="immunis_dendritic_service")
    ...
    logger.info("Starting immunis_dendritic_service...")
    yield
    logger.info("Shutting down immunis_dendritic_service...")


app = FastAPI(
    title="immunis_dendritic_service",
    version="0.1.0",
    lifespan=lifespan,
)
...
async def health():
    ...
    return {"status": "healthy", "service": "immunis_dendritic_service"}
