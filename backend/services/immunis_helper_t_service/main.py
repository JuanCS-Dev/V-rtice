"""
immunis_helper_t_service - FastAPI service
"""
import logging
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        configure_constitutional_logging(
            service_name="immunis_helper_t_service",
        ...
        auto_update_sabbath_status("immunis_helper_t_service")
        ...
        # Health
        health_checker = ConstitutionalHealthCheck(service_name="immunis_helper_t_service")
    ...
    logger.info("Starting immunis_helper_t_service...")
    yield
    logger.info("Shutting down immunis_helper_t_service...")


app = FastAPI(
    title="immunis_helper_t_service",
    version="0.1.0",
    lifespan=lifespan,
)
...
async def health():
    ...
    return {"status": "healthy", "service": "immunis_helper_t_service"}
...
async def root():
    """Root endpoint."""
    return {
        "service": "immunis_helper_t_service",
        "version": "0.1.0",
        "status": "running",
    }
