"""
immunis_macrophage_service - FastAPI service
"""
import logging
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        configure_constitutional_logging(
            service_name="immunis_macrophage_service",
        ...
        auto_update_sabbath_status("immunis_macrophage_service")
        ...
        # Health
        health_checker = ConstitutionalHealthCheck(service_name="immunis_macrophage_service")
    ...
    logger.info("Starting immunis_macrophage_service...")
    yield
    logger.info("Shutting down immunis_macrophage_service...")


app = FastAPI(
    title="immunis_macrophage_service",
    version="0.1.0",
    lifespan=lifespan,
)
...
async def health():
    ...
    return {"status": "healthy", "service": "immunis_macrophage_service"}
