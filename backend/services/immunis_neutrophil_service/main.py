"""
immunis_neutrophil_service - FastAPI service
"""
import logging
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        configure_constitutional_logging(
            service_name="immunis_neutrophil_service",
        ...
        auto_update_sabbath_status("immunis_neutrophil_service")
        ...
        # Health
        health_checker = ConstitutionalHealthCheck(service_name="immunis_neutrophil_service")
    ...
    logger.info("Starting immunis_neutrophil_service...")
    yield
    logger.info("Shutting down immunis_neutrophil_service...")


app = FastAPI(
    title="immunis_neutrophil_service",
    version="0.1.0",
    lifespan=lifespan,
)
...
async def health():
    ...
    return {"status": "healthy", "service": "immunis_neutrophil_service"}
...
async def root():
    """Root endpoint."""
    return {
        "service": "immunis_neutrophil_service",
        "version": "0.1.0",
        "status": "running",
    }
