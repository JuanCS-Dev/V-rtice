...
class TestPaginationMeta:
    ...
    def test_pagination_meta_from_params_first_page(self):
        ...
        pagination = PaginationMeta.from_params(page=1, page_size=10, total_items=25)
        assert pagination.page == 1
        assert pagination.page_size == 10
    ...
    def test_pagination_meta_from_params_middle_page(self):
        ...
        pagination = PaginationMeta.from_params(page=2, page_size=10, total_items=30)
    ...
    def test_pagination_meta_from_params_last_page(self):
        ...
        pagination = PaginationMeta.from_params(page=3, page_size=10, total_items=25)
    ...
    def test_pagination_meta_from_params_zero_items(self):
        ...
        pagination = PaginationMeta.from_params(page=1, page_size=10, total_items=0)
    ...
    def test_pagination_meta_from_params_exact_page_size(self):
        ...
        pagination = PaginationMeta.from_params(page=1, page_size=10, total_items=10)
        assert pagination.total_pages == 1
        assert pagination.has_next is False
