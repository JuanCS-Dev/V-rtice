# BLUEPRINT 02: MMEI Goals - Autonomous Goal Generator Tests (100% Coverage)

**VERSÃO**: 1.0.0 - Anti-Burro Edition
**DATA**: 2025-10-07
**EXECUTOR**: Gemini CLI
**DEPENDÊNCIA**: BLUEPRINT 01 deve estar COMPLETO
...
### 🚫 PROIBIÇÕES (NÃO FAÇA):
1. ❌ NÃO modifique `consciousness/mmei/goals.py`
2. ❌ NÃO modifique `consciousness/mmei/monitor.py`
3. ❌ NÃO crie métodos além dos especificados
4. ❌ NÃO use placeholders, TODOs, FIXMEs
5. ❌ NÃO invente nomes de variáveis
6. ❌ NÃO simplifique testes
7. ❌ NÃO pule testes
8. ❌ NÃO questione o blueprint

### ✅ OBRIGAÇÕES (FAÇA):
1. ✅ Copie EXATAMENTE cada linha
2. ✅ Use EXATAMENTE os nomes especificados
3. ✅ Use EXATAMENTE os valores especificados
4. ✅ Execute TODOS os testes ao final
5. ✅ Relate TODOS os resultados
6. ✅ Pare se QUALQUER teste falhar
...
**Aplicação**: Testes validam geração autônoma de goals a partir de needs internos.

---

## 📁 ARQUIVO A CRIAR

**Path**: `/home/juan/vertice-dev/backend/services/maximus_core_service/consciousness/mmei/test_goals.py`
...
### SEÇÃO 2: TESTES DE Goal (40 testes)
...
### SEÇÃO 3: TESTES DE GoalGenerationConfig
...
### SEÇÃO 4: TESTES DE AutonomousGoalGenerator - Init e Registro
...
### SEÇÃO 5: TESTES DE generate_goals - Core Logic (20 testes)
...
### SEÇÃO 6: TESTES DE update_active_goals
...
### SEÇÃO 7: TESTES DE Goal Creation Methods (30 testes)
...
### SEÇÃO 8: TESTES DE Query Methods e Consumer
...
python -m pytest consciousness/mmei/test_goals.py -v --tb=short
...
```markdown
# BLUEPRINT 02 - MMEI GOALS TESTS - RELATÓRIO
...
[Se COMPLETO: "Pronto para BLUEPRINT 03"]
