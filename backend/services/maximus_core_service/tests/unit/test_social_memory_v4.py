"""Unit tests for compassion.social_memory (V4 - ABSOLUTE PERFECTION)
...
class TestSocialMemoryConfig:
    """Tests for SocialMemoryConfig (V4 - Absolute perfection)."""
...
class TestSocialMemory:
    """Tests for SocialMemory (V4 - Absolute perfection)."""

    def test_init_with_type_hints(self):
        """Test initialization with type-aware args (V4)."""
        obj = SocialMemory(None)
        assert obj is not None
