"""Constitutional Compliance Tests for maximus_oraculo_v2.
...
@pytest.fixture
def client():
    """Create a test client for maximus_oraculo_v2."""
    from fastapi import FastAPI
    from shared.metrics_exporter import MetricsExporter
    from shared.health_checks import ConstitutionalHealthCheck

    app = FastAPI()
    metrics_exporter = MetricsExporter(service_name="maximus_oraculo_v2", version="1.0.0")
