...
class TestBaseServiceConfig:
    ...
    def test_service_name_validation_min_length(
    ...
    def test_service_name_validation_max_length(
        self, monkeypatch: pytest.MonkeyPatch
    ) -> None:
    ...
    def test_log_level_validation_lowercase(
        self, monkeypatch: pytest.MonkeyPatch
    ) -> None:
    ...
    def test_cors_origins_from_string_with_spaces(
        self, monkeypatch: pytest.MonkeyPatch
    ) -> None:
    ...
    def test_jwt_expiration_validation_min(
        self, monkeypatch: pytest.MonkeyPatch
    ) -> None:
    ...
    def test_jwt_expiration_validation_max(
        self, monkeypatch: pytest.MonkeyPatch
    ) -> None:
...
class TestBaseServiceConfigMethods:
    ...
    def test_model_dump_safe_masks_secrets(
        self, monkeypatch: pytest.MonkeyPatch
    ) -> None:
    ...
    def test_validate_required_vars_success(
        self, monkeypatch: pytest.MonkeyPatch
    ) -> None:
    ...
    def test_validate_required_vars_missing(
        self, monkeypatch: pytest.MonkeyPatch
    ) -> None:
    ...
    def test_validate_required_vars_empty_string(
        self, monkeypatch: pytest.MonkeyPatch
    ) -> None:
    ...
    def test_validate_required_vars_multiple_missing(
        self, monkeypatch: pytest.MonkeyPatch
    ) -> None:
    ...
    def test_generate_env_example_with_constraints(self) -> None:
        ...
        class ConfigWithConstraints(BaseServiceConfig):
            multiple_field: int = Field(
                default=10, multiple_of=5, description="Multiple field"
            )
