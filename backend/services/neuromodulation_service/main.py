"""
neuromodulation_service - FastAPI service
"""
import logging
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        configure_constitutional_logging(
            service_name="neuromodulation_service",
        ...
        auto_update_sabbath_status("neuromodulation_service")
        ...
        # Health
        health_checker = ConstitutionalHealthCheck(service_name="neuromodulation_service")
    ...
    logger.info("Starting neuromodulation_service...")
    yield
    logger.info("Shutting down neuromodulation_service...")


app = FastAPI(
    title="neuromodulation_service",
    version="0.1.0",
    lifespan=lifespan,
)
...
async def health():
    ...
    return {"status": "healthy", "service": "neuromodulation_service"}
...
async def root():
    """Root endpoint."""
    return {
        "service": "neuromodulation_service",
        "version": "0.1.0",
        "status": "running",
    }
