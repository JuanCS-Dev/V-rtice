...
class RateLimiter:
    ...
    _redis_client: Optional["aioredis.Redis"] = field(
    ...
    async def _check_redis(self, identifier: str, cost: int) -> tuple[bool, float]:
        ...
        if allowed:
            ...
            oldest_timestamp = await self._redis_client.zrange(
...
def create_rate_limiter(
    max_requests: int = 100, window_seconds: int = 60, redis_url: str | None = None
) -> RateLimiter:
    """
