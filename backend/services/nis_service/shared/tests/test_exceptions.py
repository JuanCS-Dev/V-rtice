...
class TestVerticeException:
    ...
    def test_context_property(self):
        ...
        exc = VerticeException(
            "Error", error_code="ERR", status_code=400, details={"x": 1}
        )
        ctx = exc.context
...
class TestBusinessLogicExceptions:
    ...
    def test_state_transition_error_with_details(self):
        ...
        exc = StateTransitionError(
            "pending", "cancelled", details={"reason": "Already processed"}
        )
...
class TestAnalysisExceptions:
    ...
    def test_insufficient_data_error(self):
        ...
        exc = InsufficientDataError(
            "Not enough training data", details={"min_required": 100, "current": 45}
        )
...
class TestThreatExceptions:
    ...
    def test_malware_detected_error_with_details(self):
        ...
        exc = MalwareDetectedError(
            "ransomware", "hash456", details={"file": "/tmp/evil.exe"}
        )
