...
class EventRouter:
    ...
    def determine_immune_response_type(
        ...
        if (
            ...
            or "malware" in attack_type
            or "payload" in attack_type
        ):
            return "nk_cell"
    ...
    def transform_immune_response_for_reactive_fabric(
        ...
        return {
            ...
            "recommended_action": action_map.get(
                immune_event.response_action, "continue_monitoring"
            ),
    ...
    def __repr__(self) -> str:
        return (
            f"EventRouter(routed={self.events_routed}, dropped={self.events_dropped})"
        )
