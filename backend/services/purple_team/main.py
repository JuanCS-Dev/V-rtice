...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        auto_update_sabbath_status("purple_team")
        ...
        # Health
        health_checker = ConstitutionalHealthCheck(service_name="purple_team")
    ...
    logger.info("Starting purple_team...")
    yield
    logger.info("Shutting down purple_team...")
...
async def health():
    ...
    return {"status": "healthy", "service": "purple_team"}
