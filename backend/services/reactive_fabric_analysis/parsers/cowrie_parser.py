...
class CowrieJSONParser(ForensicParser):
    ...
    def supports(self, file_path: Path) -> bool:
        ...
        return (
            ...
            'cowrie' in file_path.name.lower()
        )
                    ...
                    try:
                        ...
                        if session_id and session_id not in data['sessions']:
                            data['sessions'][session_id] = {
                                "start_time": data['timestamps'][-1] if data['timestamps'] else None,
                                "commands": [],
                                "credentials": [],
                                "downloads": []
                            }
                        ...
                        if event_id == 'cowrie.login.success':
                            ...
                            if session_id:
                                data['sessions'][session_id]['credentials'].append(credential)
                        ...
                        # Process commands
                            ...
                            if command:
                                ...
                                if session_id:
                                    data['sessions'][session_id]['commands'].append(command)
