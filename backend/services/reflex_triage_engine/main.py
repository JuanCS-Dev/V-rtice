"""
reflex_triage_engine - FastAPI service
"""
import logging
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        auto_update_sabbath_status("reflex_triage_engine")
        ...
        # Health
        health_checker = ConstitutionalHealthCheck(service_name="reflex_triage_engine")
    ...
    logger.info("Starting reflex_triage_engine...")
    yield
    logger.info("Shutting down reflex_triage_engine...")


app = FastAPI(
    title="reflex_triage_engine",
    version="0.1.0",
    lifespan=lifespan,
)
...
async def health():
    ...
    return {"status": "healthy", "service": "reflex_triage_engine"}
