...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        auto_update_sabbath_status("seriema_graph")
        ...
        # Health
        health_checker = ConstitutionalHealthCheck(service_name="seriema_graph")
    ...
    logger.info("Starting seriema_graph...")
    yield
    logger.info("Shutting down seriema_graph...")
...
async def health():
    ...
    return {"status": "healthy", "service": "seriema_graph"}
