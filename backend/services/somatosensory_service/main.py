"""
somatosensory_service - FastAPI service
"""
import logging
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        configure_constitutional_logging(
            service_name="somatosensory_service",
        ...
        auto_update_sabbath_status("somatosensory_service")
        ...
        # Health
        health_checker = ConstitutionalHealthCheck(service_name="somatosensory_service")
    ...
    logger.info("Starting somatosensory_service...")
    yield
    logger.info("Shutting down somatosensory_service...")


app = FastAPI(
    title="somatosensory_service",
    version="0.1.0",
    lifespan=lifespan,
)
...
async def health():
    ...
    return {"status": "healthy", "service": "somatosensory_service"}
