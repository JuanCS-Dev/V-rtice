"""
strategic_planning_service - FastAPI service
"""
import logging
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        configure_constitutional_logging(
            service_name="strategic_planning_service",
        ...
        auto_update_sabbath_status("strategic_planning_service")
        ...
        # Health
        health_checker = ConstitutionalHealthCheck(service_name="strategic_planning_service")
    ...
    logger.info("Starting strategic_planning_service...")
    yield
    logger.info("Shutting down strategic_planning_service...")


app = FastAPI(
    title="strategic_planning_service",
    version="0.1.0",
    lifespan=lifespan,
)
...
async def health():
    ...
    return {"status": "healthy", "service": "strategic_planning_service"}
