...
async def startup_event():
    ...
    try:
        ...
        configure_constitutional_logging(
            service_name="system_architect_service",
        ...
        auto_update_sabbath_status("system_architect_service")
        ...
        # Health
        health_checker = ConstitutionalHealthCheck(service_name="system_architect_service")
