"""
tataca_ingestion - FastAPI service
"""
import logging
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        auto_update_sabbath_status("tataca_ingestion")
        ...
        # Health
        health_checker = ConstitutionalHealthCheck(service_name="tataca_ingestion")
    ...
    logger.info("Starting tataca_ingestion...")
    yield
    logger.info("Shutting down tataca_ingestion...")


app = FastAPI(
    title="tataca_ingestion",
    version="0.1.0",
    lifespan=lifespan,
)
...
async def health():
    ...
    return {"status": "healthy", "service": "tataca_ingestion"}
