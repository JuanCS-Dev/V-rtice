...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        configure_constitutional_logging(
            service_name="threat_intel_bridge",
            log_level=os.getenv("LOG_LEVEL", "INFO"),
            json_logs=True
        )
        ...
        auto_update_sabbath_status("threat_intel_bridge")
        ...
        # Health
        health_checker = ConstitutionalHealthCheck(service_name="threat_intel_bridge")
