"""
vestibular_service - FastAPI service
"""
import logging
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        configure_constitutional_logging(
            service_name="vestibular_service",
        ...
        auto_update_sabbath_status("vestibular_service")
        ...
        # Health
        health_checker = ConstitutionalHealthCheck(service_name="vestibular_service")
    ...
    logger.info("Starting vestibular_service...")
    yield
    logger.info("Shutting down vestibular_service...")


app = FastAPI(
    title="vestibular_service",
    version="0.1.0",
    lifespan=lifespan,
)
...
async def health():
    ...
    return {"status": "healthy", "service": "vestibular_service"}
