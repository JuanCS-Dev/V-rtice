"""
vuln_intel_service - FastAPI service
"""
import logging
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        configure_constitutional_logging(
            service_name="vuln_intel_service",
        ...
        auto_update_sabbath_status("vuln_intel_service")
        ...
        # Health
        health_checker = ConstitutionalHealthCheck(service_name="vuln_intel_service")
    ...
    logger.info("Starting vuln_intel_service...")
    yield
    logger.info("Shutting down vuln_intel_service...")


app = FastAPI(
    title="vuln_intel_service",
    version="0.1.0",
    lifespan=lifespan,
)
...
async def health():
    ...
    return {"status": "healthy", "service": "vuln_intel_service"}
