        ...
        try:
            ...
            return BurpVulnerability(
                ...
                request=base64.b64decode(
                    issue.get('request', '')
                ).decode('utf-8', errors='ignore') if issue.get('request') else '',
                response=base64.b64decode(
                    issue.get('response', '')
                ).decode('utf-8', errors='ignore') if issue.get('response') else '',
