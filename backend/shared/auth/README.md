...
```json
{
  "access_token": "EXAMPLE_ACCESS_TOKEN_XXXXX",
  "refresh_token": "EXAMPLE_REFRESH_TOKEN_XXXXX",
  "token_type": "Bearer",
  "expires_in": 3600,
  "user": {
    "user_id": "user-001",
...
curl http://localhost:8000/api/auth/me \
  -H "Authorization: Bearer EXAMPLE_ACCESS_TOKEN_XXXXX"
```
...
```json
{
  "access_token": "EXAMPLE_NEW_ACCESS_TOKEN_XXXXX",
  "token_type": "Bearer",
  "expires_in": 3600
}
```
