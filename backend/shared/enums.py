"""
Vértice Platform - Centralized Enumerations
============================================

This module contains all enumerated types used across the Vértice cybersecurity platform.
Enums provide type-safe, validated constants with string representations for APIs and UIs.

Features:
    - Type-safe enum classes extending str and Enum
...
class MalwareFamily(str, Enum):
    ...
    DROPPER = "dropper"
    LOADER = "loader"
    STEALER = "stealer"  # Credential/data stealer
...
class AttackTechnique(str, Enum):
    ...
    T1068_EXPLOIT_VULNERABILITY = "T1068"
    T1134_ACCESS_TOKEN_MANIPULATION = "T1134"

    # Defense Evasion
    T1027_OBFUSCATED_FILES = "T1027"
    T1055_PROCESS_INJECTION = "T1055"
    T1070_INDICATOR_REMOVAL = "T1070"

    # Credential Access
    T1110_BRUTE_FORCE = "T1110"
    T1003_CREDENTIAL_DUMPING = "T1003"
    T1056_KEYLOGGING = "T1056"

    # Exfiltration
    T1041_EXFIL_C2_CHANNEL = "T1041"
    T1048_EXFIL_ALTERNATIVE = "T1048"

    # Impact
    T1486_DATA_ENCRYPTED_IMPACT = "T1486"  # Ransomware
