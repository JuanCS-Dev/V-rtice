    ...
    >
      ...
      >
        <header className="flex items-center justify-between p-4 bg-gray-200 border-b border-gray-300">
          <h2 className="text-xl font-bold text-gray-700">Relatório de Inteligência Veicular</h2>
          <div className="flex items-center space-x-2">
            <button id="print-button" onClick={handlePrint} className="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition-colors text-sm">Imprimir / Salvar PDF</button>
            <button id="close-button" onClick={onClose} className="text-gray-600 hover:text-black transition-colors text-2xl leading-none">&times;</button>
          </div>
        </header>
