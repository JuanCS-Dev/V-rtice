        ...
        <form onSubmit={handleSubmit} className={styles.formContainer}>
            <div className={styles.formGroup}>
                ...
                <textarea
                    ...
                    disabled={loading}
                />
                <button type="button" className={styles.sampleButton} onClick={onGenerateSample} disabled={loading}>
            ...
            <div className={styles.formGroup}>
                <label htmlFor="sensitivity-slider">Sensibilidade: {(sensitivity * 100).toFixed(0)}%</label>
                <input
