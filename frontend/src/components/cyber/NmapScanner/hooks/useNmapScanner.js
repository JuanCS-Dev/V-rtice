...
const DEFAULT_PROFILES = {
  quick: {
    name: "Quick Scan",
    description: "Scan rápido das portas mais comuns",
    command: "-T4 -F",
  },
  intense: {
    name: "Intense Scan",
    description: "Scan detalhado com detecção de serviços",
    command: "-T4 -A -v",
  },
  stealth: {
    name: "Stealth Scan",
    description: "Scan sigiloso (SYN scan)",
    command: "-sS -T4",
  },
  ping: {
    name: "Ping Scan",
    description: "Apenas verifica se hosts estão ativos",
    command: "-sn",
  },
  comprehensive: {
    name: "Comprehensive",
    description: "Scan completo com scripts de vulnerabilidade",
    command: "-T4 -A -v --script=default,vuln",
  },
};
