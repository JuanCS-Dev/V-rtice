...
const OSINTHeader = ({
  ...
  const modules = [
    ...
    {
      id: "aurora",
      name: t("dashboard.osint.modules.aurora"),
      icon: "🧠",
      isAI: true,
    },
    {
      id: "socialmedia",
      name: t("dashboard.osint.modules.socialmedia"),
      icon: "🔎",
      isWorldClass: true,
    },
    {
      id: "breachdata",
      name: t("dashboard.osint.modules.breachdata"),
      icon: "💾",
      isWorldClass: true,
    },
    {
      id: "google",
      name: t("dashboard.osint.modules.google"),
      icon: "🌎",
      isWorldClass: true,
    },
    {
      id: "darkweb",
      name: t("dashboard.osint.modules.darkweb"),
      icon: "🌑",
      isWorldClass: true,
    },
      ...
      <div className="flex items-center justify-between px-4 py-3">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-red-400/70 text-sm tracking-widest">
              {t("dashboard.osint.subtitle")}
            </p>
          </div>
        </div>
      ...
      >
        ...
        >
          {modules.map((module, index) => (
            ...
            >
              <span className="mr-1.5 text-[10px]" aria-hidden="true">
                {module.icon}
              </span>
              {module.name}
              {module.isWorldClass && (
