      ...
      <div className="flex flex-col gap-3.5 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <p className="text-[11px] text-[rgb(var(--text-tertiary))] mt-2 font-medium tracking-wide leading-none">
            Neural Gatekeeper & Signal Routing
          </p>
        </div>
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center gap-2">
            ...
            <CardTitle>Neural Signal Router</CardTitle>
          </div>
          <CardDescription className="mt-2">
            Inspired by the biological thalamus, this service acts as the
            central relay and gatekeeper for all neural signals in the Vértice
            system. It intelligently routes information between different
            subsystems, filters unnecessary noise, and prioritizes critical
            security signals for immediate processing.
          </CardDescription>
        </CardHeader>
      </Card>
    </div>
