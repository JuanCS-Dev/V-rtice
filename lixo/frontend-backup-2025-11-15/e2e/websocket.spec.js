...
test.describe("Real-time Event Toasts", () => {
  test("deve exibir live toast quando evento WebSocket chega", async ({
    page,
  }) => {
    await page.goto("/");
    await page.locator("text=PENELOPE").first().click();
...
test.describe("WebSocket Reconnection", () => {
  test("deve tentar reconectar quando WebSocket desconecta", async ({
    page,
  }) => {
    await page.goto("/");
    await page.locator("text=MABA").first().click();
...
test.describe("Service-Specific WebSocket Events", () => {
  test("PENELOPE deve receber eventos de healing", async ({ page }) => {
    ...
    const healingEvent = page.locator(
      "text=diagnóstico, text=patch, text=Sabbath",
    );
  ...
  test("MABA deve receber eventos de navegação", async ({ page }) => {
    ...
    const navigationEvent = page.locator(
      "text=sessão, text=navegou, text=cognitive map",
    );
  ...
  test("MVP deve receber eventos de narrativas", async ({ page }) => {
    ...
    const narrativeEvent = page.locator(
      "text=narrativa, text=anomalia, text=pulse",
    );
...
test.describe("WebSocket Error Handling", () => {
  ...
  test("não deve crashar com mensagens WebSocket malformadas", async ({
    page,
  }) => {
    await page.goto("/");
    await page.locator("text=MVP").first().click();
