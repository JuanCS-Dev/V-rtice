    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Ajuste efeitos e acessibilidade</CardDescription>
        </CardHeader>
        ...
        <CardContent className="pt-6">
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-1">
              <p className="text-sm font-medium">Temas Adaptativos</p>
              <p className="text-sm text-muted-foreground">
                Cada tema ajusta cores, tipografia e espaçamento para criar
                experiências únicas. As configurações são salvas automaticamente
