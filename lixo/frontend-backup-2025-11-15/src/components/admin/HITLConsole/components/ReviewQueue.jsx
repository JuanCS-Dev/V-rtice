  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.filters}>
        ...
        >
          <option value="">
            {t("hitl.queue.all_severities", "All Severities")}
          </option>
          <option value="critical">
            {t("hitl.queue.critical", "Critical")}
          </option>
        ...
        <select
          ...
          onChange={(e) =>
            onFiltersChange({
              ...filters,
              wargame_verdict: e.target.value || null,
            })
          }
          aria-label={t("hitl.queue.filter_verdict", "Filter by verdict")}
        >
          <option value="">
            {t("hitl.queue.all_verdicts", "All Verdicts")}
          </option>
          ...
          <option value="inconclusive">
            {t("hitl.queue.inconclusive", "Inconclusive")}
          </option>
        </select>
      </div>
          ...
          reviews.map((review) => (
            ...
            >
              ...
              <div className={styles.queueItemHeader}>
                <span
                  className={`${styles.severityBadge} ${getSeverityClass(review.severity)}`}
                >
              ...
              <div className={styles.queueItemFooter}>
                <span
                  className={`${styles.verdictBadge} ${getVerdictClass(review.wargame_verdict)}`}
                >
              ...
              <div className={styles.confidenceBar}>
                <div
                  ...
                  style={{
                    width: `${(review.confirmation_confidence * 100).toFixed(0)}%`,
                  }}
                />
              </div>
            </button>
