  ...
  return (
    <div className={styles.resultsContainer}>
      ...
      <div className={styles.card}>
        <h5>
          <i className="fas fa-chart-bar" aria-hidden="true"></i> Resumo da
          Análise
        </h5>
        <div className={styles.summaryGrid}>
          <div className={styles.summaryStat}>
            <span className={`${styles.statIcon} icon-critical`}>
          ...
          <div className={styles.summaryStat}>
            <span className={`${styles.statIcon} icon-analytics`}>
          ...
          <div className={styles.summaryStat}>
            <span className={`${styles.statIcon} icon-warning`}>
              <i className="fas fa-percentage" aria-hidden="true"></i>
            </span>
            <div className={styles.statContent}>
              <span className={styles.statValue}>
          ...
          {result.anomalies.map((anomaly, index) => (
            <div key={index} className={styles.anomalyCard}>
              <div className={styles.anomalyHeader}>
                <span className={styles.anomalyIndex}>
                  Anomalia #{index + 1}
                </span>
                <Badge variant={anomaly.severity?.toLowerCase()} size="sm">
