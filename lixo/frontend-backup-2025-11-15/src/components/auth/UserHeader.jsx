...
const UserHeader = () => {
  ...
  return (
    <div className="bg-gray-900 border-b border-red-400/30 px-6 py-3">
      <div className="flex items-center justify-between">
        {/* Left side - System info */}
        <div className="flex items-center space-x-4">
          <div className="text-red-400 font-bold text-xl tracking-wider">
            🛡️ PROJETO VÉRTICE
          </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative">
            ...
            {/* Dropdown menu */}
            {showDropdown && (
              <div className="absolute right-0 mt-2 w-64 bg-gray-900 border border-red-400/30 rounded-lg shadow-xl z-50">
                <div className="p-4">
                  {/* User info */}
