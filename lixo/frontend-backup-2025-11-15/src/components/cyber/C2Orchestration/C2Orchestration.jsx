    ...
    >
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-red-400/60 text-sm mt-1">
              Cobalt Strike + Metasploit Integration | Session Passing | Attack
              Chains | Port 8035
            </p>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="bg-black/50 border border-red-400/30 rounded px-4 py-2">
              ...
              <div className="text-2xl font-bold text-red-400">
                {
                  sessions.filter(
                    (session) => session?.framework === "cobalt_strike",
                  ).length
                }
              </div>
            </div>
            ...
            <div className="bg-black/50 border border-red-400/30 rounded px-4 py-2">
              ...
              <div className="text-2xl font-bold text-red-400">
                {
                  sessions.filter(
                    (session) => session?.framework === "metasploit",
                  ).length
                }
              </div>
            </div>
      ...
      >
        <div className="flex justify-between items-center text-xs text-red-400/60">
          ...
          <div>C2 ORCHESTRATION v3.0 | MAXIMUS AI KILL CHAIN</div>
        </div>
      </footer>
