        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-red-400/60 text-sm mt-1">
              Unified Orchestration | Multi-Service Workflows | Attack Chains |
              Port 8037
            </p>
          </div>
          ...
          <div className="flex gap-4">
            <div className="bg-black/50 border border-red-400/30 rounded px-4 py-2">
              ...
              <div className="text-2xl font-bold text-red-400">
                {workflows.length || predefinedWorkflows.length}
              </div>
            </div>
      ...
      >
                  ...
                  >
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <h4
                            className={`text-${workflow.color}-400 font-bold text-lg`}
                          >
                            {workflow.name}
                          </h4>
                          <p
                            className={`text-${workflow.color}-400/60 text-sm`}
                          >
                            {workflow.desc}
                          </p>
                        </div>
                      ...
                      <div
                        className={`px-3 py-1 bg-${workflow.color}-400/20 border border-${workflow.color}-400/40 rounded text-${workflow.color}-400 text-sm font-bold`}
                      >
        ...
        {activeTab === "executions" && (
          <div
            id="executions-panel"
            role="tabpanel"
            aria-labelledby="executions-tab"
            tabIndex={0}
                  ...
                  {execution.status === "running" && execution.current_step && (
                    <div className="mb-4">
                      <div className="flex justify-between text-sm mb-2">
                        <span>
                          Step {execution.current_step} of{" "}
                    ...
                    <div className="grid grid-cols-4 gap-3 mt-4">
                      <div className="bg-black/50 border border-red-400/30 rounded p-3 text-center">
                        <div className="text-red-400 text-xl font-bold">
                          {execution.results.hosts_scanned || 0}
                        </div>
                      ...
                      <div className="bg-black/50 border border-orange-400/30 rounded p-3 text-center">
                        <div className="text-orange-400 text-xl font-bold">
                          {execution.results.vulns_found || 0}
                        </div>
          ...
          >
            <div className="bg-gradient-to-br from-red-900/20 to-orange-900/20 border border-red-400/30 rounded-lg p-8 text-center">
              ...
              <p className="text-red-400/60 mb-6">
                Visual workflow builder for creating custom multi-service attack
                chains
              </p>
