...
export const CVEDetails = ({ cve, onGetExploits }) => {
  ...
  return (
    <div className="bg-gradient-to-br from-red-900/30 to-pink-900/30 border-2 border-red-400/40 rounded-lg overflow-hidden shadow-2xl shadow-red-400/20">
      {/* Header */}
      <div className="bg-gradient-to-r from-red-900/50 to-pink-900/50 p-6 border-b border-red-400/30">
        <div className="flex items-start justify-between">
          ...
          <div className="ml-6 bg-black/50 border-2 border-red-400/40 rounded-lg p-4 text-center min-w-[120px]">
            ...
            <div className="text-red-400/40 text-xs mt-1">/ 10.0</div>
          </div>
        </div>
      </div>
      ...
      <div className="p-6 space-y-6">
        ...
        {/* CWE Information */}
        {(cve.cwe_id || cve.cwe) && (
          <div className="bg-gradient-to-r from-red-900/20 to-orange-900/20 border border-red-400/30 rounded-lg p-4">
            <div className="flex items-center gap-2 mb-2">
              <span className="text-xl">🎯</span>
              <h4 className="text-red-400 font-bold">WEAKNESS TYPE</h4>
            </div>
        ...
        {cve.references && cve.references.length > 0 && (
          <div className="bg-gradient-to-r from-red-900/20 to-pink-900/20 border border-red-400/30 rounded-lg p-4">
            <div className="flex items-center gap-2 mb-2">
              <span className="text-xl">🔗</span>
              <h4 className="text-red-400 font-bold">REFERENCES</h4>
            </div>
