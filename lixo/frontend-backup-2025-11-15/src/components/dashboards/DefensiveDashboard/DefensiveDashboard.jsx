...
const DEFENSIVE_MODULES = [
  ...
  },
  {
    ...
    icon: "🔐",
    component: EncryptedTrafficAnalyzer,
  },
  ...
  { id: "security", name: "SYSTEM SEC", icon: "🔒", component: SystemSecurity },
  {
    ...
    name: "CVE DATABASE",
    icon: "🐛",
    component: ExploitSearchWidget,
  },
  {
    id: "maximus",
    name: "MAXIMUS HUB",
    icon: "🤖",
    component: MaximusCyberHub,
  },
];
...
const DefensiveDashboard = ({ setCurrentView }) => {
  ...
  return (
    ...
    >
      <SkipLink href="#defensive-main-content">
      ...
      >
        ...
        >
          <DefensiveSidebar alerts={alerts} metrics={metrics} />
        </aside>
        ...
        >
          <ModuleContainer>
            {ActiveComponent ? (
              ...
              <div role="alert">Module not found</div>
            )}
          </ModuleContainer>
        </section>
      </section>
