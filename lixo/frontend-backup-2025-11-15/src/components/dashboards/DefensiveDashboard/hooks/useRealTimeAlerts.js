      ...
      [
        {
          ...
          timestamp: alert.timestamp || formatTime(new Date(), "--:--"),
        },
        ...prev,
      ].slice(0, MAX_ALERTS),
    );
        ...
        if (response.ok) {
          ...
          if (data.llm_ready && Math.random() > 0.95) {
            const alertTypes = [
              ...
              {
                type: "VULN_FOUND",
                message: "New vulnerability discovered in monitored system",
                severity: "medium",
              },
              {
                type: "ACCESS_ATTEMPT",
              ...
              {
                type: "ANOMALY",
                message: "Behavioral anomaly detected in network traffic",
                severity: "medium",
              },
              {
                type: "INTEL_UPDATE",
                message: "New threat intelligence received",
                severity: "info",
              },
            ];
