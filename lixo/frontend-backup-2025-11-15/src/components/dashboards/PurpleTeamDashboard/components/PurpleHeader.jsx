  ...
  return (
    <header
      ...
      <div className={styles.topBar}>
        <div className={styles.titleSection}>
          ...
          <div className={styles.title}>
            ...
            <div>
              <h1 id="purple-team-dashboard-title">{t('dashboard.purple.title')}</h1>
              <p className={styles.subtitle}>{t('dashboard.purple.subtitle')}</p>
            </div>
          </div>
        </div>
        ...
        <section
          ...
          <div className={`${styles.metric} ${styles.redMetric}`} data-metric-type="offensive">
          ...
          <div className={`${styles.metric} ${styles.blueMetric}`} data-metric-type="defensive">
          ...
          <div className={`${styles.metric} ${styles.purpleMetric}`} data-metric-type="coverage">
          ...
          <div className={`${styles.metric} ${styles.greenMetric}`} data-metric-type="correlation">
      ...
      <nav
        ...
        role="navigation"
        aria-label={t('dashboard.purple.navigation', 'Purple team views navigation')}
        ...
        <button
          {...getItemProps(1, {
            ...
            'data-maximus-active': activeView === 'timeline' ? 'true' : 'false'
          })}
        >
          <span className={styles.viewIcon} aria-hidden="true">⏱️</span>
        ...
        <button
          {...getItemProps(2, {
            ...
            'data-maximus-active': activeView === 'analysis' ? 'true' : 'false'
          })}
        >
