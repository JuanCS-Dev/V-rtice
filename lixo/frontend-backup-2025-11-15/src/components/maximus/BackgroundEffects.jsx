...
export const MatrixRainEffect = () => {
  ...
  useEffect(() => {
    ...
    const resizeCanvas = () => {
      ...
      logger.debug(
        "📐 MatrixRain: Canvas redimensionado:",
        canvas.width,
        "x",
        canvas.height,
      );
  ...
  return (
    <div
      style={{
        ...
        zIndex: 9999,
        background:
          "linear-gradient(135deg, rgba(15, 23, 42, 0.98), rgba(30, 27, 75, 0.98))",
        border: "1px solid rgba(139, 92, 246, 0.4)",
        borderRadius: "12px",
        padding: "0.75rem",
        backdropFilter: "blur(15px)",
        boxShadow:
          "0 8px 32px rgba(139, 92, 246, 0.2), 0 0 0 1px rgba(139, 92, 246, 0.1)",
    ...
    >
      ...
      >
        ...
        >
          {AVAILABLE_EFFECTS.find((e) => e.id === currentEffect)?.name ||
            "None"}
        </div>
      </div>
    </div>
