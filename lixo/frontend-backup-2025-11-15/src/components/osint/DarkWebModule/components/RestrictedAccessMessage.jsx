 ...
 */
const RestrictedAccessMessageComponent = React.memo(
  function RestrictedAccessMessage({ onRequestAccess, isRequestingAccess }) {
    return (
      <div className={styles.restrictedMessage}>
        <div className={styles.icon} role="img" aria-label="Warning">
          ⚠️
        </div>
