    ...
    <div className="h-full flex flex-col">
      ...
      <div className="p-4 border-b border-red-400/30">
        ...
        <div className="space-y-2">
          ...
          <div className="flex justify-between items-center">
            <span className="text-red-400/70">MÓDULOS ATIVOS</span>
            <span className="text-red-400">6/6</span>
          </div>
          <div className="flex justify-between items-center">
            <span className="text-red-400/70">PRECISÃO IA</span>
            <span className="text-red-400">{systemStats?.aiAccuracy}%</span>
          </div>
          <div className="flex justify-between items-center">
            <span className="text-red-400/70">LATÊNCIA</span>
      ...
      <div className="p-4 border-t border-red-400/30 space-y-2">
        <h4 className="text-red-400 font-bold text-sm mb-2">AÇÕES RÁPIDAS</h4>
        <button className="w-full bg-gradient-to-r from-red-600 to-orange-700 text-white font-bold py-2 px-3 rounded text-xs hover:from-red-500 hover:to-orange-600 transition-all">
          🧠 AURORA SCAN
        </button>
