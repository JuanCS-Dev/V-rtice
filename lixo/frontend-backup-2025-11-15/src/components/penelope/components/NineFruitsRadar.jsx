    ...
    ? [
        {
          fruit: "Amor",
          fullMark: 100,
          score: fruits.agape?.score || 0,
          greek: "ἀγάπη",
        },
        {
          fruit: "Alegria",
          fullMark: 100,
          score: fruits.chara?.score || 0,
          greek: "χαρά",
        },
        {
          fruit: "Paz",
          fullMark: 100,
          score: fruits.eirene?.score || 0,
          greek: "εἰρήνη",
        },
        {
          fruit: "D.Próprio",
          fullMark: 100,
          score: fruits.enkrateia?.score || 0,
          greek: "ἐγκράτεια",
        },
        {
          fruit: "Fidelidade",
          fullMark: 100,
          score: fruits.pistis?.score || 0,
          greek: "πίστις",
        },
        {
          fruit: "Mansidão",
          fullMark: 100,
          score: fruits.praotes?.score || 0,
          greek: "πραότης",
        },
        {
          fruit: "Humildade",
          fullMark: 100,
          score: fruits.tapeinophrosyne?.score || 0,
          greek: "ταπεινοφροσύνη",
        },
        {
          fruit: "Verdade",
          fullMark: 100,
          score: fruits.aletheia?.score || 0,
          greek: "ἀλήθεια",
        },
        {
          fruit: "Sabedoria",
          fullMark: 100,
          score: fruits.sophia?.score || 0,
          greek: "σοφία",
        },
      ]
    : [];
  ...
  const CustomTooltip = ({ active, payload }) => {
    if (active && payload && payload.length) {
      ...
      return (
        ...
        >
          <p style={{ margin: 0, fontWeight: "bold", color: "#00ff88" }}>
            {data.fruit}
          </p>
