...
export const defensiveKeys = {
  ...
  behavioral: {
    ...
    baseline: (entityId) => [...defensiveKeys.all, 'behavioral', 'baseline', entityId],
  },
  ...
  threatIntel: {
    ...
    domain: (domain) => [...defensiveKeys.all, 'threat-intel', 'domain', domain],
...
export const offensiveKeys = {
  ...
  // C2 Orchestration
  c2Sessions: (framework) => framework
  ...
  bas: {
    ...
    coverage: (organizationId) => [...offensiveKeys.all, 'bas', 'coverage', organizationId],
  },
};
