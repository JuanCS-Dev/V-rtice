...
export const NmapArgsSchema = z
  ...
  .refine((val) => {
    ...
    message: 'Dangerous characters detected. Only alphanumeric, spaces, hyphens, dots, commas, colons, and slashes allowed',
  })
  .refine((val) => {
    // Empty is valid
    if (!val) return true;
    ...
    message: 'Invalid characters in arguments. Only alphanumeric, spaces, hyphens, dots, commas, colons, and slashes allowed',
  });
